...
class APLContinuousPushViewController: UIViewController {
    ...
    override func loadView() {
        ...
        tam = UIView(frame: CGRect(x: size.width * 0.5, y: size.height * 0.5, width: 10, height: 10))
        tam?.backgroundColor = UIColor.redColor()
        self.view.addSubview(tam!)
    ...
    func gesture(gesture: UITapGestureRecognizer){
        ...
        self.pushBehavior!.magnitude = 20.0
